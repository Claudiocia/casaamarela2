<x-jet-action-section>
    <x-slot name="title">
        {{ __('Sessões em Navegadores Web') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Encerre todas as suas sessões em outros navegadores da web. ') }}
    </x-slot>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-green-500 font-semibold">{{ __('Este device') }}</span>
                                    @else
                                        {{ __('Últimas atividades') }} {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
